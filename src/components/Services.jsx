import { Activity, Accessibility, Heart, Bone, Briefcase, MonitorPlay } from 'lucide-react';
import './Services.css';
...
const servicesList = [
  ...
  { 
    ...
    desc: "Virtual assessment and guided exercise sessions from the comfort and safety of your own home." 
  }
];
      ...
      <div className="services-container">
        <div className="services-header text-center">
          ...
          <p className="services-subtitle-text">
            We offer a wide range of specialized physical therapy treatments customized to your unique lifestyle and goals.
          </p>
        </div>
